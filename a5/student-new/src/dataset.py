...
if __name__ == '__main__':
    ...
    if args.dataset_type == 'namedata':
        ...
        corruption_dataset = CharCorruptionDataset(open_utf8('wiki.txt').read(), 128) 
        # Make the name dataset
        name_dataset = NameDataset(corruption_dataset,
            open_utf8('birth_places_train.tsv').read())
        ...
        # this code shows the first four examples from the name_datset
        pass
